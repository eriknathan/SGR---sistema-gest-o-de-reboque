# SGR Backend — Agent Memory Index

## Project

- [project_accounts_app.md](project_accounts_app.md) — CustomUser model, EmailBackend, login/logout views (Sprint 1)
- [project_settings_auth.md](project_settings_auth.md) — Auth settings, LANGUAGE_CODE, TIME_ZONE, TEMPLATES config
